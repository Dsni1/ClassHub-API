    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatRoomUsers", x => new { x.chatroom_id, x.user_id });
                    table.ForeignKey(
                        name: "FK_ChatRoomUsers_ChatRooms_chatroom_id",
                        column: x => x.chatroom_id,
                        principalTable: "ChatRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatRoomUsers_Users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    replaces_token = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoles", x => new { x.user_id, x.role_id, x.organisation_id });
                    table.ForeignKey(
                        name: "FK_UserRoles_Organisations_organisation_id",
                        column: x => x.organisation_id,
                        principalTable: "Organisations",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupUsers", x => new { x.group_id, x.user_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRoomUsers_user_id",
                table: "ChatRoomUsers",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_organisation_id",
                table: "Groups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_organisation_id",
                table: "UserRoles",
                column: "organisation_id");
